...
<section class="demo-details"> <!-- start details -->
    <div class="demo-desc">
        ...
        <p>
            Mission Freelance : s'inspirer de la charte graphique de l'application Tsoh Activities pour redesigner leur page web et uniformiser les contenus.
        </p>
    </div>
    <div class="demo-infos">
        <h3 class="demo-title">Rôle</h3>
        <ul>
            <li class="demo-details-item">Designer UI</li>
        </ul>
    ...
    <div class="demo-skills">
        ...
        <ul>
            <li class="demo-details-item">Design d'Interface</li>
            <li class="demo-details-item">Sketch/Zeplin</li>
        </ul>
    </div>
</section> <!-- end details -->
